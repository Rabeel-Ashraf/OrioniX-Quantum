						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use OrionIX Quantum and seek support from the community.')}
								</div>
							</div>
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								{#if $config?.license_metadata}
									<a
										href="https://docs.orionxquantumui.com/enterprise"
										target="_blank"
						...
						{#if adminConfig?.ENABLE_API_KEY_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<!-- https://docs.orionxquantumui.com/getting-started/advanced-topics/api-endpoints -->
									<a
										href="https://docs.orionxquantumui.com/getting-started/api-endpoints"
										target="_blank"
