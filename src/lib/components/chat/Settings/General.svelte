				...
				>
					...
					<a
						class="font-medium underline {($settings?.highContrastMode ?? false)
							...
							: 'text-gray-300'}"
						href="https://github.com/OrionIX Quantum/OrionIX Quantum/blob/main/docs/CONTRIBUTING.md#-translations-and-internationalization"
						target="_blank"
					>
						Help us translate OrionIX Quantum!
					</a>
				</div>
			{/if}
